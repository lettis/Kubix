...
namespace KBX {
  ...
  void GLWidget::initializeGUI(){
    ...
    chbx_autoRefresh->setToolTip(
      "Auto-Refresh will cause the scene to be redrawn regularly,"
    ...
    chbx_relativeMarking->setToolTip(
      "Relative Marking will cause the keyboard controls for marking"
