  ...
  void TextureHandler::load(std::map<size_t, std::string> files){
      ...
      for(std::map<size_t, std::string>::iterator it = files.begin(); it != files.end(); it++){
          ...
          this->textures[i] = bindTexture(
                                QPixmap( QString(it->second.c_str()) ),
                                GL_TEXTURE_2D
                              );
...
/*
  ...
  void loadTextures(){
      ...
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_K_W,  "./res/sidek.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_1_W,  "./res/side1.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_2_W,  "./res/side2.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_3_W,  "./res/side3.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_4_W,  "./res/side4.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_5_W,  "./res/side5.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_6_W,  "./res/side6.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_K_B, "./res/sidekb.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_1_B, "./res/side1b.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_2_B, "./res/side2b.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_3_B, "./res/side3b.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_4_B, "./res/side4b.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_5_B, "./res/side5b.png")  );
      dieFaces.insert(  std::pair<size_t, std::string> (Die::FACE_6_B, "./res/side6b.png")  );
      // initialize (load) die face textures
      Die::textures.load(dieFaces);
  }
  */
} // end namespace
